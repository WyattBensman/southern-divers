          ...
          <div className="flex flex-col md:w-3/5">
            ...
            <div className="text-lg font-light">
              <p className="mb-2">
                ...
                worry-free coastal experience with thorough inspections and
                seamless seawall/piling repairs across Southern Florida.
              </p>
              <p>
                ...
                expertise and experience, we guarantee tranquility by
                efficiently managing time and costs to deliver top-quality work
                across the the{" "}
